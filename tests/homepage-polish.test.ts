...
describe('homepage polish', () => {
    test('hero code editor reads as a branded product surface', () => {
        ...
        expect(cssBlock(editor, '.hero-code-editor {')).toContain('background: #1e1e1e');
        expect(cssBlock(editor, '.hero-code-editor {')).toContain('border: 1px solid #3e3e42');
        expect(cssBlock(editor, '.hero-code-editor {')).toContain('font-family: var(--font-code)');
        expect(cssBlock(editor, '.hero-code-editor__titlebar,')).toContain('background: #181818');
        expect(cssBlock(editor, '.hero-code-editor__titlebar,')).toContain('border-color: #333333');
        expect(cssBlock(editor, '.hero-code-editor__tab[data-active="true"]')).toContain('background: #1e1e1e');
        expect(cssBlock(editor, '.hero-code-editor__tab[data-active="true"]')).toContain('border-bottom: 2px solid #007acc');
        expect(cssBlock(editor, '.hero-code-editor__body {')).toContain('height: 320px');
        expect(cssBlock(editor, '.hero-code-editor__body {')).toContain('background: #1e1e1e');
        ...
        expect(cssBlock(editor, '.hero-code-editor__tab:focus-visible')).toContain('box-shadow: 0 0 0 3px rgba(0, 122, 204, 0.45)');
        expect(cssBlock(editor, '.hero-code-editor__line[data-current="true"]')).toContain('background: #2a2d2e');
