      ...
      <MainContent className="bg-[var(--academy-canvas)]">
        ...
        >
          ...
          <LegalSection id="privacy-security" number="05" title="การรักษาความปลอดภัย">
            ...
            <ul>
              <li>จัดเก็บรหัสผ่านเป็นค่าแฮช โดยใช้ Argon2id สำหรับรหัสผ่านที่ตั้งใหม่ และยังรองรับ bcrypt ของบัญชีเดิม</li>
              <li>เมื่อตั้งรหัสผ่านใหม่ ระบบส่งเฉพาะส่วนต้น 5 ตัวของค่า SHA-1 ไปยังบริการ Pwned Passwords เพื่อตรวจข้อมูลรั่วไหล ไม่ส่งรหัสผ่านหรืออีเมลไปกับคำขอนี้</li>
