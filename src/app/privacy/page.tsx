    ...
    <>
      ...
      <MainContent className="bg-[var(--academy-canvas)]">
        <LegalDocument
          ...
          updatedLabel="อัปเดตล่าสุด: 13 กันยายน 2569"
          sections={sections}
        >
          <LegalSection id="privacy-collection" number="01" title="ข้อมูลที่เราเก็บรวบรวม">
            <p>ผู้ควบคุมข้อมูลส่วนบุคคลคือ ปฏิภาณ เพ็งเภา ผู้ดำเนินการเว็บไซต์ MilerDev ติดต่อเรื่องข้อมูลส่วนบุคคลได้ที่ milerdev.official@gmail.com</p>
            ...
            <ul>
              ...
              <li><strong>สถิติส่วนเสริมเมื่อยินยอม:</strong> การดูคอร์ส การคลิก การซื้อและการเรียน รวมถึงตัวชี้วัดความเร็วเว็บ สถิติบางรายการอาจเชื่อมกับบัญชีหรือรายการชำระเงิน ไม่ใช่ข้อมูลนิรนามทั้งหมด</li>
            </ul>
          </LegalSection>
          ...
          <LegalSection id="privacy-sharing" number="03" title="การแบ่งปันข้อมูล">
            ...
            <ul>
              ...
              <li><strong>ผู้ตรวจสอบสลิป:</strong> SlipOK สำหรับตรวจสอบหลักฐานการโอนเงิน</li>
              <li><strong>ผู้ให้บริการวิดีโอ:</strong> Bunny.net หรือผู้ให้บริการของวิดีโอที่ฝัง สำหรับแสดงบทเรียนและวิดีโอตัวอย่าง</li>
              <li><strong>การเข้าสู่ระบบด้วย Google:</strong> รับข้อมูลบัญชีที่จำเป็นเมื่อคุณเลือกใช้ช่องทางนี้</li>
          ...
          <LegalSection id="privacy-cookies" number="04" title="คุกกี้ (Cookies)">
            ...
            <ul>
              ...
              <li><strong>ตัวเลือกความเป็นส่วนตัว:</strong> คุกกี้ milerdev_consent ใช้อ้างอิงตัวเลือกที่บันทึกไว้ อายุสูงสุด 180 วัน ไม่ใช้เป็นรหัสติดตามสถิติ</li>
              <li><strong>การจดจำการปิดประกาศ:</strong> ใช้ sessionStorage ในแท็บของเบราว์เซอร์</li>
            </ul>
            <p>สถิติส่วนเสริมของ MilerDev เริ่มปิดจนกว่าคุณยินยอม แม้สถิติบางประเภทไม่ได้ใช้คุกกี้ติดตาม การปฏิเสธไม่ขัดขวางการสมัครสมาชิก ซื้อคอร์ส หรือเรียน ข้อมูลชำระเงิน สิทธิ์เรียน และความคืบหน้าที่จำเป็นต่อบริการยังคงบันทึกตามการให้บริการ</p>
            <p>ตัวเล่นวิดีโอ Bunny ติดต่อผู้ให้บริการเมื่อโหลดในหน้าบทเรียน และอาจส่งข้อมูลทางเทคนิคก่อนกดเล่น เช่น ค่าความหน่วงและคุณภาพการเล่น เพื่อส่งวิดีโอและดูแลประสิทธิภาพ ตามเอกสารของ Bunny ตัวเล่นอาจใช้ localStorage ในเบราว์เซอร์เพื่อจดจำการตั้งค่าหรือตำแหน่งเล่น ข้อมูลเหล่านี้แยกจากสถิติส่วนเสริมของ MilerDev และไม่ได้ควบคุมด้วยตัวเลือกสถิติของเว็บไซต์ อ่านรายละเอียดจาก <a href="https://bunny.net/docs/stream/data-and-privacy">เอกสารข้อมูลและความเป็นส่วนตัวของ Bunny</a></p>
            <p>เปลี่ยนตัวเลือกหรือถอนความยินยอมได้จากปุ่มด้านล่าง ส่วนท้ายเว็บไซต์ หรือหน้าตั้งค่าบัญชี การถอนหยุดการเก็บสถิติส่วนเสริมของ MilerDev ในอนาคต เมื่อเข้าสู่ระบบ การเลือกใหม่จะแทนตัวเลือกสถิติเดิมของบัญชี อุปกรณ์อื่นต้องเลือกใหม่ ระบบไม่ส่งเหตุการณ์ก่อนยินยอมย้อนหลัง</p>
            <p>เราบันทึกรุ่นของคำอธิบาย ตัวเลือก เวลาเลือก วันหมดอายุ และเวลาถอน โดยไม่บันทึก IP หรือประเภทเบราว์เซอร์ในหลักฐานตัวเลือกนี้ หากเลือกขณะเข้าสู่ระบบ หลักฐานจะผูกกับบัญชีเพื่อควบคุมสถิติที่ประมวลผลภายหลัง</p>
          ...
          <LegalSection id="privacy-rights" number="06" title="สิทธิ์ของคุณ">
            ...
            <ul>
              ...
              <li><strong>สิทธิ์ถอนความยินยอม:</strong> เปลี่ยนตัวเลือกสถิติได้ทุกเมื่อ การถอนความยินยอมไม่ใช่การลบประวัติการซื้อหรือข้อมูลเดิมทั้งหมด หากต้องการใช้สิทธิเกี่ยวกับข้อมูลเดิม กรุณาติดต่อเรา</li>
            </ul>
