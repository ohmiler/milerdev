      ...
      <MainContent className="bg-[var(--academy-canvas)]">
        ...
        >
          ...
          <LegalSection id="privacy-cookies" number="04" title="คุกกี้ (Cookies)">
            ...
            <p>สถิติส่วนเสริมเริ่มปิดจนกว่าคุณยินยอม แม้สถิติบางประเภทไม่ได้ใช้คุกกี้ติดตาม การปฏิเสธไม่ขัดขวางการสมัครสมาชิก ซื้อคอร์ส หรือเรียน ข้อมูลชำระเงิน สิทธิ์เรียน และความคืบหน้าที่จำเป็นต่อบริการยังคงบันทึกตามการให้บริการ</p>
            <p>เปลี่ยนตัวเลือกหรือถอนความยินยอมได้จากปุ่มด้านล่าง ส่วนท้ายเว็บไซต์ หรือหน้าตั้งค่าบัญชี การถอนหยุดการเก็บสถิติในอนาคต เมื่อเข้าสู่ระบบ การเลือกใหม่จะแทนตัวเลือกสถิติเดิมของบัญชี อุปกรณ์อื่นต้องเลือกใหม่ ระบบไม่ส่งเหตุการณ์ก่อนยินยอมย้อนหลัง</p>
