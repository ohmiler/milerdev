...
export const FAQ_CATEGORIES: FAQCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        link: { href: '/courses', label: 'ดูคอร์สทั้งหมด' },
      },
      {
        q: 'สมัครสมาชิกฟรีไหม?',
  ...
  },
  {
    ...
    items: [
      ...
      {
        q: 'ขอคืนเงินได้ไหม?',
        a: 'รายละเอียดเรื่องการชำระเงินและการคืนเงินอยู่ในเงื่อนไขการใช้งาน กรุณาตรวจสอบก่อนตัดสินใจชำระเงิน',
        link: { href: '/terms#terms-payment', label: 'อ่านเงื่อนไขการชำระเงิน' },
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        link: { href: '/forgot-password', label: 'ไปหน้าลืมรหัสผ่าน' },
      },
      {
        ...
        link: { href: '/contact', label: 'ติดต่อทีมเรื่องอีเมล' },
      },
      {
        ...
        link: { href: '/contact', label: 'เปิดหน้าติดต่อ' },
      },
    ],
  },
];
