...
interface LegalDocumentProps { eyebrow: string; title: string; lede: string; updatedLabel: string; sections: Array<{ id: string; title: string }>; children: ReactNode }
