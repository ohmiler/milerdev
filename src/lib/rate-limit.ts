...
/**
 * Lightweight in-memory limiter for non-auth API routes and optimistic proxy defense.
 * Authentication mutations use the authoritative MySQL-backed limiter instead.
 */
